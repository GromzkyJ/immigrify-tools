    ...
    <div className="App">
      <div className="calculator">
        ...
        <div className="keypad">
          ...
          <button className="key key-operator" onClick={() => performOperation('/')}>
            ÷
          </button>
          <button className="key key-operator" onClick={() => performOperation('*')}>
            ×
          ...
          <button className="key key-equals" onClick={handleEquals} rowSpan={2}>
            =
          </button>
          ...
          <button className="key key-number key-zero" onClick={() => inputNumber(0)}>
            0
          </button>
          <button className="key key-number" onClick={inputDecimal}>
            .
          </button>
        </div>
      </div>
